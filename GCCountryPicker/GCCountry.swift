...
public final class GCCountry: NSObject {
    ...
    public init?(countryCode: String) {
        ...
        if let callingCode = GCCountry.callingCode(forCountryCode: self.countryCode), let localizedDisplayName = Locale(identifier: Locale.preferredLanguages.first!).localizedString(forRegionCode: self.countryCode) {
